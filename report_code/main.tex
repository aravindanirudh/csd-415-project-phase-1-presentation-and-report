...
\fancyhead[LO,LE]{\small College of Engineering, Cherthala}
\fancyfoot[L]{\small Department of Computer Science and Engineering}
\fancyfoot[LO,LE]{\small Department of Computer Science and Engineering}
...
% Redefine plain style so chapter-opening pages also have the exact same header and footer
\fancypagestyle{plain}{
  \fancyhf{}
  \fancyhead[L]{\small College of Engineering, Cherthala}
  \fancyhead[LO,LE]{\small College of Engineering, Cherthala}
