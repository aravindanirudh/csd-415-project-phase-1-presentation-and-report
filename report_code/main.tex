...
\begin{figure}[H]
  \centering
  \includegraphics[height=0.62\textheight,keepaspectratio]{ArchitectureDiagram.drawio.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{DFD_0.drawio.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{DFD_1.drawio.png}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.17\textwidth]{uml_sequence_diagram.png}%
      }
